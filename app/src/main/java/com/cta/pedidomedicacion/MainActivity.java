...
new Med("Tobrex colirio 3 mg/ml", 1, "frasco", "Nevera / estantería / mueble"));restoreMetadata();}
 ...
 void build(){
  ...
  Button o=btn("REALIZAR PEDIDO");o.setOnClickListener(v->showOrder());bar.addView(o,new LinearLayout.LayoutParams(0,dp(52),1));root.addView(bar,new LinearLayout.LayoutParams(-1,dp(58)));
